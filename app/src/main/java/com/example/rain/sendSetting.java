...
public class sendSetting extends AppCompatActivity {
    ...
    private void recipient(){
        final BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(sendSetting.this, R.style.BottomSheetDialogTheme);
    ...
    private void close() {
        final Dialog dialog = new Dialog(sendSetting.this);
